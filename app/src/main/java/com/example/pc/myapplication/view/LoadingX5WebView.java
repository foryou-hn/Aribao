 ...
 * 带加载条和视频全屏的webview
 */
public class LoadingX5WebView extends WebView {
    ...
    public LoadingX5WebView(Context context) {
        this(context, null);
    }

    public LoadingX5WebView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingX5WebView(Context context, AttributeSet attrs, int defStyle) {
